            ...
            <div class="flex">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                    ...
                    <a href="{{ route('booking.list.page') }}" class="inline-flex items-center px-1 pt-1 border-b-2 
                              ...
                              text-sm font-medium hover:border-gray-300 hover:text-gray-700" data-role="user">
                        Daftar Booking
                    </a>
                    <a href="{{ route('qr.reader.page') }}" class="inline-flex items-center px-1 pt-1 border-b-2 
                              ...
                              text-sm font-medium hover:border-gray-300 hover:text-gray-700" data-role="admin">
                        Scan Tiket
                    </a>
                </div>
            </div>
    ...
    <div class="sm:hidden hidden" id="mobile-menu">
        <div class="space-y-1 pt-2 pb-3">
            ...
            <a href="{{ route('booking.list.page') }}" class="block pl-3 pr-4 py-2 border-l-4 
                      {{ Route::is('booking.list.page') ? 'border-indigo-500 text-indigo-700 bg-indigo-50' : 'border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800' }}" data-role="user">
                Daftar Booking
            </a>
            <a href="{{ route('qr.reader.page') }}" class="block pl-3 pr-4 py-2 border-l-4 
                      {{ Route::is('qr.reader.page') ? 'border-indigo-500 text-indigo-700 bg-indigo-50' : 'border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800' }}" data-role="admin">
                Scan Tiket
            </a>
        </div>
