<!-- Toast Warning -->
<div id="toast-warning" class="hidden flex items-center w-full max-w-sm p-4 text-gray-500 bg-indigo-50 rounded-lg shadow-lg dark:text-gray-400 dark:bg-gray-800 mb-1" role="alert">
...
<!-- Toast Success -->
<div id="toast-success" class="hidden flex items-center w-full max-w-sm p-4 text-gray-500 bg-indigo-50 rounded-lg shadow-lg dark:text-gray-400 dark:bg-gray-800 mb-1" role="alert">
...
<!-- Toast Question -->
<div id="toast-question" class="hidden flex items-center w-full max-w-sm p-4 text-gray-500 bg-indigo-50 rounded-lg shadow-lg dark:text-gray-400 dark:bg-gray-800 mb-1" role="alert">
    <div class="flex">
